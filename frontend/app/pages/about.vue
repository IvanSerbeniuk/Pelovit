...
useHead({
  ...
  meta: [{ name: 'description', content: 'Аксімед — інноваційне підприємство з 1985 року. Розробляємо натуральну косметику на основі наукових досліджень.' }],
})
</script>
...
<section class="section-nagoroda">
  <div class="container p-5">
    ...
    <div class="nagoroda_img text-center">
      <img :src="'/images/nagorods.png'" alt="" class="img-fluid">
    </div>
  </div>
</section>
...
<section class="py-5 doslidgenja_section">
  <div class="container">
    <div class="row g-5 align-items-center">
      ...
      <div class="col-lg-4">
        <img :src="'/images/science_in_laboratory.png'" alt="Дослідження в лабораторії" class="research-img img-fluid">
      </div>
      <div class="col-lg-4">
...
<section class="values_section py-5">
  <div class="container">
    ...
    <div class="row g-4">
      <div class="col-md-3"><div class="value-card text-center"><h5 class="fw-bold">Інноваційність</h5><p>Поєднуємо науку та природу.</p></div></div>
      <div class="col-md-3"><div class="value-card text-center"><h5 class="fw-bold">Якість</h5><p>Кожен продукт проходить контроль.</p></div></div>
      <div class="col-md-3"><div class="value-card text-center"><h5 class="fw-bold">Прозорість</h5><p>Відкриті у складі та діях засобів.</p></div></div>
      <div class="col-md-3"><div class="value-card text-center"><h5 class="fw-bold">Клієнт</h5><p>Продукти, що дійсно працюють.</p></div></div>
    </div>
  </div>
</section>
...
<section class="kontractne_vyrobnyctvo_page cert-section">
  <div class="container">
    ...
    <div class="row g-5 justify-content-center">
      <div class="col-lg-5 col-md-6"><div class="cert-card"><img :src="'/images/sertificate1.png'" alt="Сертифікат GMP ISO 22716" class="cert-image"></div></div>
      <div class="col-lg-5 col-md-6"><div class="cert-card"><img :src="'/images/sertificate2.png'" alt="Сертифікат GMP ISO 22716" class="cert-image"></div></div>
    </div>
  </div>
</section>
</template>
