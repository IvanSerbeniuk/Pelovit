  ...
  <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
    ...
    <div class="carousel-inner">
      ...
      <div v-for="(banner, i) in banners" :key="banner.id" :class="['carousel-item', i === 0 ? 'active' : '']">
        <div class="hero text-white" :style="banner.image ? `background-image: linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.45)), url(${assetUrl(banner.image)})` : 'background-image: linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.45)), url(/images/gl_face.png)'">
          <div class="container">
            <div class="col-lg-6 mob">
      ...
      <div v-for="category in categories" :key="category.id" class="cat_card">
        <NuxtLink :to="`/catalog?category=${category.slug}`" class="text-decoration-none text-dark">
          <div class="category-card">
            <img :src="assetUrl(category.image)" class="rounded-4 w-100" :alt="category.name">
