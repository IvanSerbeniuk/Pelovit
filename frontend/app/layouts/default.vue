        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mx-auto gap-1">
            <li class="nav-item cat-blue radius">
              <div class="wrapper">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><rect x="1" y="1" width="7" height="7" rx="1.5" stroke="#422928" stroke-width="1.5"/><rect x="12" y="1" width="7" height="7" rx="1.5" stroke="#422928" stroke-width="1.5"/><rect x="1" y="12" width="7" height="7" rx="1.5" stroke="#422928" stroke-width="1.5"/><rect x="12" y="12" width="7" height="7" rx="1.5" stroke="#422928" stroke-width="1.5"/></svg>
