<x-guest-layout>
    @section('title', 'Новий пароль — PELOVIT-R')

    <h4 class="fw-bold mb-4 text-center">Новий пароль</h4>
    ...
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <button type="submit" class="btn btn-brown w-100 py-2 rounded-3">Зберегти пароль</button>
    </form>
</x-guest-layout>
