    ...
    <div class="row g-5 align-items-center">
      <div class="col-lg-5">
        <div class="p-4 value-card">
          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330" alt="Ім'я Прізвище" class="founder-photo img-fluid mb-4">
  ...
  <div class="container">
    ...
    <div class="timeline row g-5 text-center">
      <div class="col-lg-4 timeline-item">
        <img :src="'/images/handwash3.jpg'" alt="2010" class="img-fluid mb-4">
        <div class="year">2010</div>
        <p class="mt-3">Заснування бренду, початок виробництва спа-косметики.</p>
      </div>
      <div class="col-lg-4 timeline-item">
        <img :src="'/images/handwash3.jpg'" alt="2016" class="img-fluid mb-4">
        <div class="year">2016</div>
        <p class="mt-3">Початок контрактного виробництва для сторонніх брендів.</p>
      </div>
      <div class="col-lg-4 timeline-item">
        <img :src="'/images/handwash3.jpg'" alt="2022" class="img-fluid mb-4">
      ...
      <div class="col-lg-6 timeline-item m-0">
        ...
        <img :src="'/images/handwash3.jpg'" alt="2013" class="img-fluid mb-4">
      </div>
      <div class="col-lg-6 timeline-item m-0">
        <div class="year">2019</div>
        <p class="mt-3">Відкриття мережі дистрибуції по Україні та онлайн-продажів.</p>
        <img :src="'/images/handwash3.jpg'" alt="2019" class="img-fluid mb-4">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="row g-5 justify-content-center">
      <div class="col-lg-5 col-md-6">
        <div class="cert-card">
          <img :src="'/images/sertificate1.png'" alt="Сертифікат GMP ISO 22716 - Англійська версія" class="cert-image">
        </div>
      </div>
      <div class="col-lg-5 col-md-6">
        <div class="cert-card">
          <img :src="'/images/sertificate2.png'" alt="Сертифікат GMP ISO 22716 - Українська версія" class="cert-image">
        </div>
      </div>
    </div>
  </div>
...
<section class="watcheus_section">
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-md-3 col-6"><img :src="'/images/catname4.png'" alt="" class="img-fluid"></div>
      <div class="col-md-3 col-6"><img :src="'/images/face_washing.png'" alt="" class="img-fluid"></div>
      <div class="col-md-3 col-6"><img :src="'/images/catname5.png'" alt="" class="img-fluid"></div>
      <div class="col-md-3 col-6"><img :src="'/images/catname3.png'" alt="" class="img-fluid"></div>
    </div>
  </div>
</section>
</template>
